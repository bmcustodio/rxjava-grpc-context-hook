 ...
 * order to enable gRPC context propagation.
 */
public final class GrpcContextPropagatingOnScheduleAction implements Func1<Action0, Action0> {
  @Override
  public Action0 call(final Action0 action0) {
    return new GrpcContextPropagatingAction(action0);
  }
}
